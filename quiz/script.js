...
const quizData = [
    ...
    },
    {
        ...
        answers: ["HTML", "JavaScript", "PHP", "Python"],
        correct: 2,
    },
    {
        question: "Qu'est-ce que CSS signifie dans le contexte du développement web?",
        answers: ["Counter Style Sheets", "Cascading Style Sheets ", "Computer Style Sheets", "Creative Style Sheets"],
        correct: 1,
    },
    {
        question: "Quel format de fichier est couramment utilisé pour les images sur le web?",
        answers: ["TXT", "GIF", " MP3", "PNG"],
        correct: 3,
    },
    {
        question: "Quel langage est principalement utilisé pour structurer le contenu d'une page web?",
        answers: ["JavaScript", "PHP", "Css", "HTML"],
        correct: 3,
    },
